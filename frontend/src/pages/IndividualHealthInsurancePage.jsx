      ...
      <section className="section-pad">
        <div className="rounded-[2rem] border border-slate-200 bg-white px-6 py-10 shadow-[0_30px_80px_rgba(15,23,42,0.06)] sm:px-10">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <Link className="gradient-border rounded-[1.5rem] border border-[var(--line)] bg-[var(--panel-soft)] px-5 py-5 font-semibold text-slate-950 transition hover:bg-white hover:scale-[1.02]" to="/contact?tab=individual">
              Enroll Now
            </Link>
          </div>
        </div>
