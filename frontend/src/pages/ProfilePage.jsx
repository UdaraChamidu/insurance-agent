  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-900 dark:to-slate-900 transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {/* Profile Card */}
        <div className="bg-white dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-white/20 p-8 mb-8 flex flex-col md:flex-row items-center md:items-start gap-6 shadow-xl transition-colors duration-300">
          ...
          <button 
            ...
            className="px-6 py-2 bg-red-100 dark:bg-red-500/10 hover:bg-red-200 dark:hover:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-500/30 rounded-lg flex items-center gap-2 transition-all font-medium"
          >
        ...
        {/* Analytics Grid */}
        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 px-1">Performance Overview</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-xl p-6 hover:shadow-lg dark:hover:bg-white/10 transition-all">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Account Settings */}
          <div className="bg-white dark:bg-white/5 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-white/10 p-6 shadow-lg transition-colors duration-300">
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 dark:bg-black/30 border border-gray-300 dark:border-white/10 rounded-lg px-4 py-2 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-colors" 
                  placeholder="••••••••" 
                />
              </div>
              <div>
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-white/10 p-6 shadow-lg transition-colors duration-300">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-black/20 rounded-xl transition-colors">
